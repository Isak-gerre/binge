...
form.addEventListener("submit", (event) => {
  ...
  if (error == 1) {
    ...
    const req2 = new Request("https://d.r101.wbsprt.com/api.bingy.se/POST/log-in-verification.php", {
      method: "POST",
      body: formData,
    });
    ...
    fetch(req2)
      ...
      .then((data) => {
        ...
        window.location.replace("https://d.r101.wbsprt.com/bingy.se/feed.php");
      })
      .catch((error) => {
